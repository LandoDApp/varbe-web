...
export default function AbstraktPage() {
    const t = useTranslations('styles.abstrakt');
    ...
    useEffect(() => {
        const fetchArtworks = async () => {
            try {
                ...
                const abstractKeywords = ['abstrakt', 'abstract', 'abstrakte', 'abstrakter', 'abstraktes', 'non-figurativ', 'nonfigurativ'];
