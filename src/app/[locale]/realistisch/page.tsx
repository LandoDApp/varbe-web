...
export default function RealistischPage() {
    const t = useTranslations('styles.realistisch');
    ...
    useEffect(() => {
        const fetchArtworks = async () => {
            try {
                ...
                const realisticKeywords = ['realistisch', 'realistic', 'realismus', 'realism', 'naturalistisch', 'naturalistic', 'portrait', 'porträt', 'landscape', 'landschaft'];
