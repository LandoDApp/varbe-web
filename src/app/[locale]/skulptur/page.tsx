...
export default function SkulpturPage() {
    const t = useTranslations('categories.skulptur');
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="container mx-auto px-4 py-12 max-w-7xl">
                    ...
                    <>
                        ...
                        {artworks.length > 12 && (
                            <div className="text-center mt-8">
                                <Link href="/marketplace?category=sculpture">
                ...
                <section className="mt-12 space-y-6 font-body text-lg">
                    ...
                    <h3 className="text-2xl font-heading mt-8">{t('seoMaterialsTitle')}</h3>
                    <p>
                        {t('seoMaterialsText')}
                    </p>
                    <ul className="list-disc list-inside ml-4 space-y-2">
                        <li><strong>{t('seoMaterials.clay').split(':')[0]}:</strong> {t('seoMaterials.clay').split(':')[1]}</li>
                        <li><strong>{t('seoMaterials.metal').split(':')[0]}:</strong> {t('seoMaterials.metal').split(':')[1]}</li>
                        <li><strong>{t('seoMaterials.stone').split(':')[0]}:</strong> {t('seoMaterials.stone').split(':')[1]}</li>
                        <li><strong>{t('seoMaterials.wood').split(':')[0]}:</strong> {t('seoMaterials.wood').split(':')[1]}</li>
                        <li><strong>{t('seoMaterials.glass').split(':')[0]}:</strong> {t('seoMaterials.glass').split(':')[1]}</li>
                        <li><strong>{t('seoMaterials.mixed').split(':')[0]}:</strong> {t('seoMaterials.mixed').split(':')[1]}</li>
                    </ul>
                    <h3 className="text-2xl font-heading mt-8">{t('seoPlacementTitle')}</h3>
                    <p>
                        {t('seoPlacementText')}
                    </p>
                </section>
