...
export default function FotografiePage() {
    const t = useTranslations('categories.fotografie');
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="container mx-auto px-4 py-12 max-w-7xl">
                    ...
                    <>
                        ...
                        {artworks.length > 12 && (
                            <div className="text-center mt-8">
                                <Link href="/marketplace?category=photography">
                ...
                <section className="mt-12 space-y-6 font-body text-lg">
                    ...
                    <h3 className="text-2xl font-heading mt-8">{t('seoGenresTitle')}</h3>
                    <p>
                        {t('seoGenresText')}
                    </p>
                    <ul className="list-disc list-inside ml-4 space-y-2">
                        <li><strong>{t('seoGenres.landscape').split(':')[0]}:</strong> {t('seoGenres.landscape').split(':')[1]}</li>
                        <li><strong>{t('seoGenres.portrait').split(':')[0]}:</strong> {t('seoGenres.portrait').split(':')[1]}</li>
                        <li><strong>{t('seoGenres.street').split(':')[0]}:</strong> {t('seoGenres.street').split(':')[1]}</li>
                        <li><strong>{t('seoGenres.abstract').split(':')[0]}:</strong> {t('seoGenres.abstract').split(':')[1]}</li>
                        <li><strong>{t('seoGenres.fineart').split(':')[0]}:</strong> {t('seoGenres.fineart').split(':')[1]}</li>
                    </ul>
                    <h3 className="text-2xl font-heading mt-8">{t('seoPresentationTitle')}</h3>
                    <p>
                        {t('seoPresentationText')}
                    </p>
                </section>
