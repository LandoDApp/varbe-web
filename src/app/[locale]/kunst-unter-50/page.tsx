...
export default function KunstUnter50Page() {
    const t = useTranslations('priceRanges.unter50');
            ...
            <div className="container mx-auto px-4 py-12 md:py-20">
                <div className="max-w-2xl mx-auto text-center">
                    <div className="card-comic bg-gradient-to-br from-accent/20 to-pink-100 p-8 md:p-12 border-4 border-black">
                        ...
                        <h1 className="text-3xl md:text-5xl font-heading mb-4">{t('title')}</h1>
                        ...
                        <p className="text-lg font-body text-gray-700 mb-8">
                            Der Kunst-Kauf ist vorübergehend deaktiviert. 
